...
{
    public abstract class OperaWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static OperaWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(OperaWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<OperaDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<OperaDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<OperaDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<OperaDbContext, Task<T>> func)
        {
            T result;
